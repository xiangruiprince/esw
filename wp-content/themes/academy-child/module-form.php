...
<?php } ?>
	...
	<?php } else if(!ThemexCourse::isMember()) { ?>
		...
		<a href="#" class="element-button medium price-button submit-button left takecourse-button">		
			<?php if(ThemexCourse::$data['status']=='premium' && ThemexCourse::$data['product']!=0) { ?>
	...
	<?php } else { ?>
		...
		<a href="#" class="element-button secondary medium submit-button unsub-button left"><?php _e('Unsubscribe Now', 'academy'); ?></a>
